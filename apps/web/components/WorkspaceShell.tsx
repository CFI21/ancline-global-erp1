...
const links=[
  ...
  ['/finance-command-center','Finance Automation Command Center'],
  ['/automated-journals','Automated Journals'],
  ['/payment-proposals','Payment Proposals'],
  ['/collection-priorities','Collection Priorities'],
  ['/liquidity-alerts','Liquidity Alerts'],
  ['/intercompany-netting','Intercompany Netting'],
  ['/approvals','Approvals'],
  ['/tasks','My Work'],
