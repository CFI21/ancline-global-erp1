...
export default function SchedulesPage(){
  ...
  return <WorkspaceShell title="Vessel / Voyage Schedules" subtitle="Carrier schedules, voyage control, cut-offs and booking assignment" active="/schedules" actions={<button className="btn" onClick={()=>void load()}>Refresh</button>}>
    ...
    <div className="card" style={{marginBottom:12}}><h3 style={sectionTitle}>{editingId?'Edit Vessel Schedule':'Create Vessel Schedule'}</h3><div style={formGrid}>
    ...
    <div className="card" style={{marginBottom:12}}><h3 style={sectionTitle}>Assign Schedule to Booking</h3><div style={formGrid}>
