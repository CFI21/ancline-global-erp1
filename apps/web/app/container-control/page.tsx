...
const events=[['EMPTY_RELEASED','Empty Released'],['PICKED_UP','Empty Picked Up'],['GATED_IN','Gate In'],['VGM_SUBMITTED','VGM Submitted'],['LOADED','Loaded on Vessel'],['DEPARTED','Departed'],['TRANSSHIPMENT','Transshipment'],['DISCHARGED','Discharged'],['GATED_OUT','Gate Out'],['DELIVERED','Delivered'],['EMPTY_RETURNED','Empty Returned'],['CUSTOM','Custom Event']] as const;
