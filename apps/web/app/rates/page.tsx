...
export default function RatesPage(){
  ...
  >
    ...
    {convert&&<div className="card" style={{marginBottom:12}}>
      ...
      <div style={formGrid}>
        <label><span style={labelStyle}>Job Ref</span><input inputMode="numeric" maxLength={5} pattern="[0-9]{5}" style={fieldStyle} value={convert.bookingNo} onChange={e=>setConvert({...convert,bookingNo:e.target.value.replace(/\D/g,'').slice(0,5)})} placeholder="Auto 5-digit"/></label>
