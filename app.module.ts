...
@Module({
  imports:[
    ...
    ApprovalsModule,StorageModule,PortalModule,DiagnosticsModule,OperationsModule,FleetModule,SpecialCargoModule,DocumentOpsModule,LandsideModule,CommercialModule,GovernanceModule,AutomationModule,UatModule
  ]
})
