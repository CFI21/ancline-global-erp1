...
export class FinanceController {
  ...
  @Post('crt') crt(@Body() b:any,@Req() req:any){return this.s.createCrt(b,req.user)}
  @Post('crt/:id/approve') approveCrt(@Param('id') id:string,@Req() req:any){return this.s.approveCrt(id,req.user)}
}
